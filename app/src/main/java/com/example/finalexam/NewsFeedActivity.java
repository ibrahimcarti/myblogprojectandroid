...
import com.example.finalexam.databinding.ActivityNewsFeedBinding;
...
public class NewsFeedActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        runnable = new Runnable() {
            ...
            public void run() {
                loadPosts();
                handler.postDelayed(this, 5000); // 5 saniyede bir yenile
            }
        };
    ...
    protected void onStart() {
        ...
        handler.postDelayed(runnable, 5000); // 5 saniyede bir yenile
    }
